        ...
        def create_bullets(self, amount, pattern):
            ...
            if pattern == "random":
                ...
                for i in range(0, amount):
                    bossbullet = CircleBossBullet(1, pygame.Rect(0, 0, 0, 0), [0, 0], [random.randint(-360, 360)/100, random.randint(-360, 360)/100], 5)
            ...
            if pattern == "sequenced1":
                ...
                for i in range(0, int((360/(360/amount)))):
                    ...
                    bossbullet = CircleBossBullet(1, pygame.Rect(0, 0, 0, 0), [0, 0], [Vx, Vy], 5)
                    bullets.append(bossbullet)
